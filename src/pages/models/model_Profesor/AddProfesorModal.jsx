...
const AddProfesorModal = ({ open, onClose, onSave, cargosValidos = [], profesoresExistentes = [] }) => {
  ...
  // Obtener combinaciones ocupadas por tutores
  const combinacionesOcupadas = profesoresExistentes
    .filter(profesor => profesor.tutor && profesor.grado && profesor.seccion)
    .map(profesor => `${profesor.grado}${profesor.seccion}`);
                  ...
                  <FormControlLabel
                    control={
                      <Switch
                        ...
                        onChange={handleChange}
                        name="tutor"
                        disabled={!hayCombinaciónDisponible()}
                      />
                    }
                    label={profesorData.tutor ? 'Sí' : 'No'}
                  />
                  {!hayCombinaciónDisponible() && (
